...
1. `system_theme_switcher-0.1.3.zip`을 압축 해제하지 않고 준비합니다.
...
- 테스트 전용 네이티브 알림으로 실제 Blender GUI의 이벤트 수신·전환·대기 복귀를 검증했습니다. macOS 설정을 실제로 토글하는 종단 테스트는 미실시입니다.
